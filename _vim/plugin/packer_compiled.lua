...
_G.packer_plugins = {
  ...
  ["vim-sexp"] = {
    config = { '\27LJ\2\nû\f\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\0006\20sexp_outer_list\aaf\27sexp_emit_tail_element\f<M-S-k> sexp_flow_to_prev_leaf_tail\f<M-S-g>\27sexp_emit_head_element\f<M-S-j>!sexp_round_tail_wrap_element\5\30sexp_swap_element_forward\n<M-l>!sexp_curly_tail_wrap_element\5\31sexp_swap_element_backward\n<M-h>\19sexp_convolute\5\27sexp_swap_list_forward\n<M-j>\23sexp_raise_element\5\28sexp_swap_list_backward\n<M-k>\20sexp_indent_top\a=-\20sexp_raise_list\5\16sexp_indent\a==\21sexp_splice_list\5\29sexp_select_next_element\a]e\29sexp_insert_at_list_head\5\29sexp_select_prev_element\a[e!sexp_curly_head_wrap_element\5"sexp_move_to_next_top_element\a]]"sexp_square_head_wrap_element\5"sexp_move_to_prev_top_element\a[[!sexp_round_head_wrap_element\5 sexp_flow_to_next_leaf_tail\f<M-S-e>\30sexp_curly_head_wrap_list\5\31sexp_square_tail_wrap_list\5\31sexp_square_head_wrap_list\5 sexp_flow_to_next_leaf_head\f<M-S-w>\30sexp_round_head_wrap_list\5 sexp_flow_to_prev_leaf_head\f<M-S-b>\29sexp_insert_at_list_tail\5\28sexp_flow_to_next_close\n<M-}>"sexp_square_tail_wrap_element\5\27sexp_flow_to_prev_open\n<M-{>\30sexp_curly_tail_wrap_list\5\27sexp_flow_to_next_open\n<M-]>\30sexp_round_tail_wrap_list\5\28sexp_flow_to_prev_close\n<M-[>\30sexp_capture_next_element\f<M-S-l>#sexp_move_to_next_element_tail\n<M-e>#sexp_move_to_prev_element_tail\vg<M-e>#sexp_move_to_next_element_head\n<M-w>#sexp_move_to_prev_element_head\n<M-b>\30sexp_move_to_next_bracket\6)\30sexp_move_to_prev_bracket\6(\23sexp_inner_element\aie\23sexp_outer_element\aae\22sexp_inner_string\ais\22sexp_outer_string\aas\24sexp_inner_top_list\aiF\24sexp_outer_top_list\aaF\20sexp_inner_list\aif\30sexp_capture_prev_element\f<M-S-h>\18sexp_mappings\6g\bvim\0' },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'vim-sexp', 'vim-sexp-mappings-for-regular-people', 'conjure', 'rainbow'}, { ft = "clojure" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'emmet-vim'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType xml ++once lua require("packer.load")({'emmet-vim'}, { ft = "xml" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-flake8', 'vim-markdown', 'python-syntax'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType fennel ++once lua require("packer.load")({'fennel.vim', 'vim-sexp', 'vim-sexp-mappings-for-regular-people', 'aniseed', 'conjure', 'rainbow'}, { ft = "fennel" }, _G.packer_plugins)]]
