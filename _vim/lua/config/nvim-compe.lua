...
set_keymap("i", "<C-Space>", "compe#complete()", {expr = true, silent = true})
set_keymap("i", "<CR>", "compe#confirm('<CR>')", {expr = true, silent = true})
set_keymap("i", "<C-e>", "compe#close('<C-e>')", {expr = true, silent = true})
set_keymap("i", "<C-f>", "compe#scroll({ 'delta': +4 })", {expr = true, silent = true})
set_keymap("i", "<C-d>", "compe#scroll({ 'delta': -4 })", {expr = true, silent = true})
